...
function PostsComments({ post, onComment, commentInputRef }) {
  ...
  const CommentuserPlaceholder = post?.comments[0]?.user?.username
    ?.split(" ")
    .map((name) => name[0])
    .join("");
  ...
  return (
    // COMMENTS SECTION
    <div className="mt-4">
      <h3 className="font-semibold mb-2 dark:text-gray-300">Comments</h3>
      ...
      <div className="max-h-60 overflow-y-auto pr-2">
        ...
        {post?.comments?.length > 2 && (
          <p
            className="w-40 mt-2 text-blue-500 dark:text-gray-300"
      ...
      <div className="flex items-center space-x-2 mt-4">
        ...
        <Input
          ...
          className="flex-grow cursor-pointer rounded-full  h-12 dark:bg-[rgb(58,59,60)] dark:text-gray-100"
